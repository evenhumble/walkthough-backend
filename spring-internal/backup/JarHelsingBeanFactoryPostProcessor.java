...
public class JarHelsingBeanFactoryPostProcessor
    implements BeanDefinitionRegistryPostProcessor, DisposableBean {
  ...
  public void postProcessBeanFactory(
    ...
    try {
      ...
      this.jarHelsingClassLoader =
          new JarHelsingClassLoader(overridenClasspathUrls, parentClassLoader);
  ...
  private void exportSingletons(ConfigurableListableBeanFactory configurableListableBeanFactory,
                                GenericXmlApplicationContext subcontext) {
  ...
  private static GenericXmlApplicationContext createSubcontext(
      Collection<String> resourceLocations) {
