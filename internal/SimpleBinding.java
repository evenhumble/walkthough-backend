package io.hedwig.dh.corejava.internal;
...
//        simpleBinding();
    ...
    public static CallSite simpleBootstrap(
            Lookup lookup, String name, MethodType type) throws Exception {
    ...
    public static void first(Lookup lookup, MutableCallSite mcs) throws Exception {
    ...
    public static void second(Lookup lookup, MutableCallSite mcs) throws Exception {
