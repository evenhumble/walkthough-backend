package io.qkits.toolsets.telnet.server;
...
import io.qkits.toolsets.telnet.action.FileScan;
import io.qkits.toolsets.telnet.action.FileWatchAction;
import io.qkits.toolsets.telnet.telnetclient.CommandExecutor;
		...
		try{
			...
			while(runFlag){
                ...
                if(msg.startsWith("!setname=")){
                	...
                	String r = CommandExecutor.executeLinuxCmd(msg.replace("!runsh ", "").trim());
                	pw.println("RESULT: \n"+r+ "\n success!");
